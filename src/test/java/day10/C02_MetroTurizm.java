...
public class C02_MetroTurizm {
    ...
    public void test() {
        ...
        WebElement secilenTarih = driver.findElement(By.xpath("//div/table/tbody/tr/td[contains(@class, 'ui-datepicker-current-day')]"));
        ...
        WebElement donusTarihi = driver.findElement(By.xpath("//div/table/tbody/tr/td[contains(@class, 'today')]"));
